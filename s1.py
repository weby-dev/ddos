...
GOLDENEYE_BANNER = 'DDos S1 by Hyipto <@hyiptotop>'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} DDoS S1 strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
